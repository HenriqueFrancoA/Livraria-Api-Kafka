...
public class Event {
    ...
    public Event(String id, String transactionId, String orderId, Order payload, String sagaType, EEventSource source, ESagaStatus status, List<History> eventHistory, LocalDateTime createdAt) {
        this.id = id;
